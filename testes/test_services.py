from aplicacao.services import condicao_compra
...
def test_compra_subindo():
      ...
      condicao, quantity = condicao_compra(preco_atual = 111_000, saldo = 100, config = config)
...
def test_comprar_descendo():
      ...
      condicao, quantity = condicao_compra(preco_atual = 107_000, saldo = 100, config = config)
