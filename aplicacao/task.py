...
from .services import condicao_compra, condicao_fechamento, enviar_mensagem_compra, enviar_mensagem_fechamento
from index import  buscar_saldo, buscar_ordens, abrir_ordem, fechar_ordem, enviar_mensagem, limpar_compra_inf_baixo
...
def rodar_automacao(username):
      ...
      while True:
            try:
                  ...
                  resposta, quantity = condicao_compra(preco_atual, saldo, config)
                  ...
                  for ordem in ordens_abertas:
                        ...
                        valor_fechamento, lucro = condicao_fechamento(ordem, config)
                        if valor_fechamento:
